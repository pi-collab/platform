    ...
    return (
      <>
        ...
        >
          ...
          {/* The timer and the control are the same thing in two states, so
              they share one element in one place. Split across the screen they
              read as two separate offers to resend, one of them broken. */}
