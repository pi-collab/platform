      ...
      <div style={{maxWidth: '1200px', margin: '0 auto'}}>
            ...
            <section className="sr in" style={{position: 'relative', overflow: 'hidden', borderRadius: '24px', background: 'var(--card)', boxShadow: 'var(--sh-2)', padding: 'clamp(26px,3vw,40px) clamp(24px,3vw,40px) clamp(28px,3.4vw,40px)'}}>
              ...
              <div style={{position: 'relative', zIndex: '2', display: 'flex', gap: '12px', flexWrap: 'wrap', marginTop: '22px'}}>
                <Link href="/browse" className="neonbtn" style={{display: 'inline-flex', alignItems: 'center', gap: '8px', padding: '12px 20px', borderRadius: 'var(--radius-pill)', background: 'var(--lime-400)', border: '1px solid transparent', fontFamily: 'var(--font-ui)', fontWeight: '700', fontSize: '13px', color: 'var(--lime-950)', boxShadow: '0 8px 16px -8px rgba(180,215,50,.55)'}}><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round"><path d="M12 5v14M5 12h14" /></svg>Start a new deal</Link>
              </div>
            ...
            <section className="sr" style={{position: 'relative', marginTop: 'clamp(28px,3.2vw,42px)', borderRadius: '20px', background: 'var(--card)', boxShadow: '0 24px 54px -34px rgba(24,28,36,.28)', padding: 'clamp(24px,3vw,38px)'}}>
              ...
              <div>
                <Link href="/settings" className="drow" style={{display: 'grid', gridTemplateColumns: 'auto 1fr auto auto', alignItems: 'center', gap: '16px', padding: '18px 12px', borderRadius: '12px', textDecoration: 'none'}}>
                ...
                <Link href="/browse" className="drow" style={{display: 'grid', gridTemplateColumns: 'auto 1fr auto auto', alignItems: 'center', gap: '16px', padding: '18px 12px', borderRadius: '12px', borderTop: '1px solid var(--hair)', textDecoration: 'none'}}>
            ...
            <section className="sr" style={{marginTop: 'clamp(52px,6vw,80px)'}}>
              <div style={{borderRadius: '20px', background: 'var(--card)', boxShadow: 'var(--sh-2)', padding: 'clamp(24px,3vw,32px)'}}>
                ...
                <div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', padding: 'clamp(34px,4vw,52px) 0'}}>
                  ...
                  <Link href="/browse" className="neonbtn" style={{marginTop: '18px', display: 'inline-flex', alignItems: 'center', gap: '8px', padding: '12px 20px', borderRadius: 'var(--radius-pill)', background: 'var(--ink)', border: '1px solid transparent', fontFamily: 'var(--font-ui)', fontWeight: '700', fontSize: '13px', color: '#fff', boxShadow: '0 8px 16px -8px rgba(24,28,36,.35)'}}>Browse creators<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m9 18 6-6-6-6" /></svg></Link>
                </div>
              </div>
            </section>
