  ...
  return (
    <div style={{ padding: 'clamp(20px,2.6vw,34px) clamp(22px,4vw,56px) clamp(64px,6vw,110px)' }}>
              ...
              <div className="reveal panel" style={panelStyle}>
                <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 16, flexWrap: 'wrap' }}>
                  <div>
                    ...
                    <p style={{ fontSize: 13, color: 'var(--ink-faint)', margin: '6px 0 0' }}>Your public company profile creators see.</p>
                  </div>
                </div>
                ...
                <div className="form-2" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, marginTop: 22 }}>
                  ...
                  <div style={{ gridColumn: '1/-1' }}>
                    ...
                    <textarea
                      ...
                      style={{ resize: 'vertical', minHeight: 80, lineHeight: 1.55, ...fldStyle }}
                    />
                  </div>
                  <FieldSelect label="Niche / category" value={category || ''} options={['', 'D2C', 'Fashion', 'Tech & finance', 'Beauty', 'Lifestyle', 'FMCG', 'Fintech', 'Health & fitness', 'Food & beverage', 'Education', 'Gaming', 'Travel', 'Other']} onChange={v => { setCategory(v); markDirty() }} />
                ...
                {/* Social accounts */}
                <div style={{ marginTop: 24, paddingTop: 22, borderTop: '1px solid var(--border-hairline)' }}>
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 14 }}>
                    <div>
                      <h3 style={{ fontFamily: 'var(--font-display)', fontWeight: 700, fontSize: 16, margin: 0 }}>Social accounts</h3>
                      <p style={{ fontSize: 12.5, color: 'var(--ink-faint)', margin: '4px 0 0' }}>Add your social handles so creators can find you.</p>
                    </div>
                  </div>
      ...
      <style>{`
        ...
        .fld { transition: border-color .16s ease, box-shadow .16s ease; }
        .fld:focus { border-color: var(--neon-deep); box-shadow: 0 0 0 3px rgba(218,254,12,.18); }
