      ...
      <div style={{fontFamily: 'var(--font-ui)', color: 'var(--ink)', position: 'relative', overflowX: 'clip', background: '#fff'}}>
        ...
        <div style={{padding: '22px 24px 36px'}}>
          <div style={{borderRadius: '14px', overflow: 'hidden', border: '1px solid var(--hairline)'}}>
            ...
            <div style={{display: 'grid', gridTemplateColumns: '1fr 52px 52px', alignItems: 'center', borderTop: '1px solid var(--hairline)'}}><span style={{padding: '13px 16px', fontSize: '12px', color: 'var(--ink)', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis'}}>Every offer with rate, scope and dates</span><span style={{padding: '13px 8px', display: 'flex', alignItems: 'center', justifyContent: 'center', borderLeft: '1px solid var(--hairline)'}}><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#4F6B12" strokeWidth="2.6" strokeLinecap="round" strokeLinejoin="round"><path d="M20 6 9 17l-5-5" /></svg></span><span style={{padding: '13px 8px', display: 'flex', alignItems: 'center', justifyContent: 'center', borderLeft: '1px solid var(--hairline)'}}><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#C7C9C0" strokeWidth="2" strokeLinecap="round"><path d="M18 6 6 18M6 6l12 12" /></svg></span></div>
            <div style={{display: 'grid', gridTemplateColumns: '1fr 52px 52px', alignItems: 'center', borderTop: '1px solid var(--hairline)'}}><span style={{padding: '13px 16px', fontSize: '12px', color: 'var(--ink)', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis'}}>Terms locked the moment you accept</span><span style={{padding: '13px 8px', display: 'flex', alignItems: 'center', justifyContent: 'center', borderLeft: '1px solid var(--hairline)'}}><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#4F6B12" strokeWidth="2.6" strokeLinecap="round" strokeLinejoin="round"><path d="M20 6 9 17l-5-5" /></svg></span><span style={{padding: '13px 8px', display: 'flex', alignItems: 'center', justifyContent: 'center', borderLeft: '1px solid var(--hairline)'}}><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#C7C9C0" strokeWidth="2" strokeLinecap="round"><path d="M18 6 6 18M6 6l12 12" /></svg></span></div>
            <div style={{display: 'grid', gridTemplateColumns: '1fr 52px 52px', alignItems: 'center', borderTop: '1px solid var(--hairline)'}}><span style={{padding: '13px 16px', fontSize: '12px', color: 'var(--ink)', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis'}}>Revisions counted against what you agreed</span><span style={{padding: '13px 8px', display: 'flex', alignItems: 'center', justifyContent: 'center', borderLeft: '1px solid var(--hairline)'}}><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#4F6B12" strokeWidth="2.6" strokeLinecap="round" strokeLinejoin="round"><path d="M20 6 9 17l-5-5" /></svg></span><span style={{padding: '13px 8px', display: 'flex', alignItems: 'center', justifyContent: 'center', borderLeft: '1px solid var(--hairline)'}}><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#C7C9C0" strokeWidth="2" strokeLinecap="round"><path d="M18 6 6 18M6 6l12 12" /></svg></span></div>
            <div style={{display: 'grid', gridTemplateColumns: '1fr 52px 52px', alignItems: 'center', borderTop: '1px solid var(--hairline)'}}><span style={{padding: '13px 16px', fontSize: '12px', color: 'var(--ink)', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis'}}>Every change timestamped, by both sides</span><span style={{padding: '13px 8px', display: 'flex', alignItems: 'center', justifyContent: 'center', borderLeft: '1px solid var(--hairline)'}}><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#4F6B12" strokeWidth="2.6" strokeLinecap="round" strokeLinejoin="round"><path d="M20 6 9 17l-5-5" /></svg></span><span style={{padding: '13px 8px', display: 'flex', alignItems: 'center', justifyContent: 'center', borderLeft: '1px solid var(--hairline)'}}><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#C7C9C0" strokeWidth="2" strokeLinecap="round"><path d="M18 6 6 18M6 6l12 12" /></svg></span></div>
          </div>
        </div>
