        ...
        <section id="top" className="sr hr" style={{padding: '48px 24px 44px', marginTop: '28px', background: 'var(--ink)', color: '#fff'}}>
          ...
          <div style={{marginTop: '40px'}}>
            ...
            <div style={{display: 'flex', flexDirection: 'column', gap: '10px', marginTop: '14px'}}>
              ...
              <div style={{display: 'flex', alignItems: 'center', gap: '14px', padding: '16px', border: '1px solid rgba(255,255,255,.18)', borderRadius: '14px'}}><span style={{display: 'inline-flex', alignItems: 'center', justifyContent: 'center', width: '34px', height: '34px', borderRadius: '10px', background: 'rgba(232,255,102,.12)', flexShrink: '0'}}><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="var(--neon)" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z" /></svg></span><div><div style={{fontFamily: 'var(--font-display)', fontWeight: '700', fontSize: '13.5px', color: '#fff'}}>Your own shopfront</div><div style={{fontFamily: 'var(--font-ui)', fontSize: '11px', color: '#9EA096', marginTop: '3px'}}>Rates and portfolio, one link</div></div></div>
