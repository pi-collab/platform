      ...
      <div style={{padding: '20px 18px 0', background: '#F5F7FA', paddingBottom: '18px'}}>
        <div style={{display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: '10px'}}>
          ...
          <div style={{display: 'flex', alignItems: 'center', gap: '8px', flexShrink: '0'}}>
            <Link href="/creator/storefront" aria-label="Shopfront" style={{display: 'inline-flex', alignItems: 'center', gap: '5px', padding: '7px 11px', borderRadius: '999px', border: '1.3px solid transparent', background: 'var(--ink)', flexShrink: '0'}}><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z"></path></svg><span style={{fontFamily: 'var(--font-ui)', fontSize: '11.5px', fontWeight: '700', color: '#fff'}}>Shopfront</span></Link>
