    ...
    <div className="brands-page">
        ...
        <section style={{position: 'relative', width: '100vw', left: '50%', right: '50%', marginLeft: '-50vw', marginRight: '-50vw', marginTop: 'clamp(-96px,-8vw,-70px)', overflow: 'hidden', background: '#fff', zIndex: '0', paddingBottom: '40px'}}>
          <div style={{position: 'relative', overflow: 'hidden', paddingBottom: 'calc(63.92% - 60px)'}}>
            <img src="/brands/glass-panel.webp" alt="guapd campaign brief, creator, invoice and deliverable glass panel" style={{position: 'absolute', top: '0', left: '0', width: '100%', height: 'auto', display: 'block', objectPosition: 'top', transform: 'scale(0.9)', transformOrigin: 'top center'}} width={2825} height={1806} decoding="async" />
          ...
          <div style={{position: 'absolute', zIndex: '2', left: '6%', top: '50%', transform: 'translateY(-50%)', width: 'min(36%,420px)', minWidth: '200px', textAlign: 'left'}}>
            <h1 style={{fontFamily: 'var(--font-display)', fontWeight: '800', letterSpacing: '-0.03em', lineHeight: '1.02', fontSize: 'clamp(28px,3.2vw,40px)', margin: '0', color: '#12151C'}}>Everything your team needs, <span style={{fontFamily: 'var(--font-serif)', fontStyle: 'italic', fontWeight: '400'}}>in one place.</span></h1>
        ...
        <section id="top" style={{position: 'relative', overflow: 'visible', background: '#fff', padding: 'clamp(12px,1.5vw,20px) clamp(20px,5vw,72px) clamp(60px,7vw,96px)'}}>
          ...
          <div style={{maxWidth: '1200px', margin: '0 auto', position: 'relative', display: 'grid', gridTemplateColumns: '1.15fr 1fr', gap: '64px', alignItems: 'center'}}>
            <div className="sr" style={{'--sr-delay': '0s', position: 'relative', zIndex: '1', marginLeft: '75px'}}>
              ...
              <h2 style={{fontFamily: 'var(--font-display)', fontWeight: '800', letterSpacing: '-0.03em', lineHeight: '1.02', fontSize: 'clamp(26px,3vw,38px)', margin: '12px 0 0', color: '#12151C'}}>Create your next <span style={{fontFamily: 'var(--font-serif)', fontStyle: 'italic', fontWeight: '400'}}>deal.</span></h2>
        ...
        <section style={{position: 'relative', overflow: 'visible', background: '#fff', padding: '0 clamp(20px,5vw,72px) clamp(40px,5vw,64px)'}}>
          ...
          <div style={{maxWidth: '1200px', margin: '0 auto', position: 'relative', display: 'grid', gridTemplateColumns: '1fr 1.15fr', gap: '64px', alignItems: 'stretch'}}>
            ...
            <div className="sr" style={{'--sr-delay': '.12s', position: 'relative', zIndex: '1', marginLeft: '80px', marginTop: '32px'}}>
              ...
              <h2 style={{fontFamily: 'var(--font-display)', fontWeight: '800', letterSpacing: '-0.03em', lineHeight: '1.02', fontSize: 'clamp(26px,3vw,38px)', margin: '12px 0 0', color: '#12151C'}}>Every campaign, <span style={{fontFamily: 'var(--font-serif)', fontStyle: 'italic', fontWeight: '400'}}>on track.</span></h2>
        ...
        <section style={{position: 'relative', padding: 'clamp(44px,5.5vw,80px) clamp(14px,4vw,28px) clamp(44px,5.5vw,80px)'}}>
          <div style={{maxWidth: '1200px', margin: '0 auto', position: 'relative', borderRadius: '40px', overflow: 'hidden', boxShadow: '0 40px 90px -40px rgba(40,45,25,.35)'}}>
            <img src="/brands/showcase-b.webp" alt="Brand dashboard cards — active campaigns, applicants, contracts, payouts" style={{...{width: '100%', aspectRatio: '1672/941', display: 'block'}, objectFit: 'cover'}} width={1672} height={941} loading="lazy" decoding="async" />
