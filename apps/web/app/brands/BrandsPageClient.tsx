...
export default function BrandsPageClient() {
   ...
   */
  useEffect(() => {
    const els = Array.from(document.querySelectorAll('.brands-page .sr, .brands-page .sr-fade'))
    ...
    <div className="brands-page">
        ...
        <section style={{position: 'relative', width: '100vw', left: '50%', right: '50%', marginLeft: '-50vw', marginRight: '-50vw', marginTop: 'clamp(-96px,-8vw,-70px)', overflow: 'hidden', background: '#fff', zIndex: '0', paddingBottom: '40px'}}>
          <div style={{position: 'relative', overflow: 'hidden', paddingBottom: 'calc(63.92% - 60px)'}}>
            <img src="/brands/glass-panel.webp" alt="guapd campaign brief, creator, invoice and deliverable glass panel" style={{position: 'absolute', top: '0', left: '0', width: '100%', height: 'auto', display: 'block', objectPosition: 'top', transform: 'scale(0.9)', transformOrigin: 'top center'}} />
          ...
          <div style={{position: 'absolute', zIndex: '2', left: '6%', top: '50%', transform: 'translateY(-50%)', width: 'min(36%,420px)', minWidth: '200px', textAlign: 'left'}}>
            <h2 style={{fontFamily: 'var(--font-display)', fontWeight: '800', letterSpacing: '-0.03em', lineHeight: '1.02', fontSize: 'clamp(28px,3.2vw,40px)', margin: '0', color: '#12151C'}}>Everything your team needs, <span style={{fontFamily: 'var(--font-serif)', fontStyle: 'italic', fontWeight: '400'}}>in one place.</span></h2>
        ...
        <section id="top" style={{position: 'relative', overflow: 'visible', background: '#fff', padding: 'clamp(12px,1.5vw,20px) clamp(20px,5vw,72px) clamp(60px,7vw,96px)'}}>
          <div style={{maxWidth: '1200px', margin: '0 auto', position: 'relative', background: '#fff', border: '1px solid var(--hairline)', borderRadius: '32px', boxShadow: '0 40px 90px -36px rgba(40,45,25,.4)', padding: 'clamp(40px,5vw,64px)', overflow: 'visible'}}>
          ...
          <div style={{maxWidth: '1200px', margin: '0 auto', position: 'relative', display: 'grid', gridTemplateColumns: '1.15fr 1fr', gap: '64px', alignItems: 'center'}}>
            <div className="sr" style={{'--sr-delay': '0s', position: 'relative', zIndex: '1', marginLeft: '75px'}}>
              ...
              <h1 style={{fontFamily: 'var(--font-display)', fontWeight: '800', letterSpacing: '-0.03em', lineHeight: '1.02', fontSize: 'clamp(26px,3vw,38px)', margin: '12px 0 0', color: '#12151C'}}>Create your next <span style={{fontFamily: 'var(--font-serif)', fontStyle: 'italic', fontWeight: '400'}}>deal.</span></h1>
            ...
            <div className="sr" style={{'--sr-delay': '.12s', position: 'relative', minHeight: '460px', display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
              <div aria-hidden="true" className="card oh-float-r" style={{position: 'absolute', zIndex: '1', width: '88%', maxWidth: '420px', top: '6%', right: '-4%', borderRadius: '20px', background: '#F3F8FD', boxShadow: '0 30px 60px -34px rgba(40,45,25,.35)', height: '120px'}}></div>
              <div className="card oh-deals-card" style={{position: 'relative', zIndex: '2', width: '100%', maxWidth: '560px', borderRadius: '22px', background: '#fff', boxShadow: '0 36px 80px -32px rgba(40,45,25,.48)', overflow: 'hidden'}}>
                ...
                <div style={{display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '14px 22px', borderTop: '1px solid var(--border-hairline)', background: '#FAFBFC'}}><span style={{fontFamily: 'var(--font-ui)', fontSize: '12.5px', color: 'var(--ink-faint)'}}>Total pending</span><span style={{fontFamily: 'var(--font-display)', fontWeight: '800', fontSize: '16px', color: '#12151C'}}>₹1,47,000</span></div>
              </div>
            </div>
          </div>
          </div>
        ...
        <section style={{position: 'relative', overflow: 'visible', background: '#fff', padding: '0 clamp(20px,5vw,72px) clamp(40px,5vw,64px)'}}>
          <div style={{maxWidth: '1200px', margin: '0 auto', position: 'relative', background: '#fff', border: '1px solid var(--hairline)', borderRadius: '32px', boxShadow: '0 40px 90px -36px rgba(40,45,25,.4)', padding: 'clamp(40px,5vw,64px)', overflow: 'visible'}}>
          ...
          <div style={{maxWidth: '1200px', margin: '0 auto', position: 'relative', display: 'grid', gridTemplateColumns: '1fr 1.15fr', gap: '64px', alignItems: 'stretch'}}>
            <div className="sr" style={{'--sr-delay': '0s', position: 'relative', minHeight: '460px', display: 'flex', alignItems: 'center', justifyContent: 'center', marginLeft: '100px'}}>
              <div aria-hidden="true" className="card oh-float-l" style={{position: 'absolute', zIndex: '1', width: '88%', maxWidth: '420px', top: '8%', left: '-4%', borderRadius: '20px', background: '#F3F8FD', boxShadow: '0 30px 60px -34px rgba(40,45,25,.35)', height: '110px'}}></div>
              <div className="card oh-deals-card" style={{position: 'relative', zIndex: '2', width: '100%', maxWidth: '720px', borderRadius: '22px', background: '#fff', boxShadow: '0 36px 80px -32px rgba(40,45,25,.48)', overflow: 'hidden'}}>
                ...
                <div style={{display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '14px 22px', borderTop: '1px solid var(--border-hairline)', background: '#FAFBFC'}}><span style={{fontFamily: 'var(--font-ui)', fontSize: '12.5px', color: 'var(--ink-faint)'}}>Total in motion</span><span style={{fontFamily: 'var(--font-display)', fontWeight: '800', fontSize: '16px', color: '#12151C'}}>₹4,50,000</span></div>
              </div>
            </div>
            ...
            <div className="sr" style={{'--sr-delay': '.12s', position: 'relative', zIndex: '1', marginLeft: '80px', marginTop: '32px'}}>
              ...
              <h1 style={{fontFamily: 'var(--font-display)', fontWeight: '800', letterSpacing: '-0.03em', lineHeight: '1.02', fontSize: 'clamp(26px,3vw,38px)', margin: '12px 0 0', color: '#12151C'}}>Every campaign, <span style={{fontFamily: 'var(--font-serif)', fontStyle: 'italic', fontWeight: '400'}}>on track.</span></h1>
              ...
              <div style={{display: 'grid', gridTemplateColumns: 'repeat(2,1fr)', gap: '18px', marginTop: 'clamp(32px,4vw,48px)', maxWidth: '420px'}}>
                <div style={{padding: '26px 24px', border: '1px solid rgba(18,21,28,.1)', borderRadius: '16px', background: '#fff', boxShadow: '0 14px 32px -20px rgba(40,45,25,.25)'}}><div style={{fontFamily: 'var(--font-display)', fontWeight: '600', fontSize: 'clamp(26px,2.4vw,32px)', letterSpacing: '-0.02em', color: '#12151C'}}>1</div><div style={{fontFamily: 'var(--font-ui)', fontSize: '13px', color: '#565C68', marginTop: '5px'}}>Dashboard for everything</div></div>
                <div style={{padding: '26px 24px', border: '1px solid rgba(18,21,28,.1)', borderRadius: '16px', background: '#fff', boxShadow: '0 14px 32px -20px rgba(40,45,25,.25)'}}><div style={{fontFamily: 'var(--font-display)', fontWeight: '600', fontSize: 'clamp(26px,2.4vw,32px)', letterSpacing: '-0.02em', color: '#12151C'}}>Live</div><div style={{fontFamily: 'var(--font-ui)', fontSize: '13px', color: '#565C68', marginTop: '5px'}}>Delivery status</div></div>
              </div>
            </div>
          </div>
          </div>
        ...
        {/* ============ VALUE TICKER ============ */}
        <section style={{padding: 'clamp(44px,5.5vw,80px) 0 clamp(44px,5.5vw,80px)'}}>
          <div style={{position: 'relative', overflow: 'hidden', WebkitMaskImage: 'linear-gradient(90deg,transparent,#000 9%,#000 91%,transparent)', maskImage: 'linear-gradient(90deg,transparent,#000 9%,#000 91%,transparent)'}}>
            <div style={{display: 'flex', width: 'max-content', gap: '0', animation: 'mqMove 32s linear infinite'}}>
              <div style={{display: 'flex', gap: '12px', paddingRight: '12px'}}>
                <span style={{display: 'inline-flex', alignItems: 'center', gap: '8px', fontFamily: 'var(--font-ui)', fontSize: '12px', color: 'var(--ink-soft)', background: 'var(--card)', border: '1.2px solid var(--hairline)', borderRadius: 'var(--radius-pill)', padding: '9px 16px', whiteSpace: 'nowrap', boxShadow: '0 4px 12px -8px rgba(40,45,25,.15)'}}><span style={{width: '6px', height: '6px', borderRadius: '50%', background: '#7FA8E8'}}></span>locked terms</span>
          ...
          <div style={{position: 'relative', width: '100vw', left: '50%', right: '50%', marginLeft: '-50vw', marginRight: '-50vw', overflow: 'hidden', background: '#fff', paddingTop: 'clamp(320px,40vh,480px)'}}>
            <div style={{position: 'absolute', top: '0', left: '0', right: '0', height: 'clamp(320px,40vh,480px)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'flex-end', paddingBottom: '0px', textAlign: 'center', pointerEvents: 'none', zIndex: '2'}}>
              <div style={{maxWidth: '900px'}}>
                <h1 className="hero-fade" style={{margin: '0', color: '#12151C', fontSize: 'clamp(32px,4.2vw,52px)', fontFamily: 'var(--font-display)', fontWeight: '700', letterSpacing: '-0.03em', lineHeight: '1.06', '--sr-delay': '0s'}}>The operating system<br />for <span style={{fontFamily: 'var(--font-serif)', fontStyle: 'italic', fontWeight: '400'}}>creator collabs.</span></h1>
                ...
                <button type="button" className="t-content hero-fade" style={{pointerEvents: 'auto', marginTop: '24px', background: '#12151C', color: '#fff', border: 'none', borderRadius: '999px', padding: '14px 36px', minHeight: '48px', cursor: 'pointer', transition: 'transform .2s cubic-bezier(.16,1,.3,1)', '--sr-delay': '0.22s'}} sc-camel-on-mouse-over="this.style.transform='translateY(-4px)'" sc-camel-on-mouse-out="this.style.transform='translateY(0)'" sc-camel-on-mouse-down="this.style.transform='scale(0.97)'" sc-camel-on-mouse-up="this.style.transform='translateY(-4px)'">Book a demo</button>
              </div>
            </div>
            <img src="/brands/showcase-a.webp" alt="Glass panels showing campaign brief, creators, approvals, deliverables and payments" style={{display: 'block', width: '84%', height: 'auto', margin: '0 auto', aspectRatio: '1672/941', objectFit: 'cover'}} />
        ...
        <section id="how" style={{padding: 'clamp(44px,5.5vw,80px) clamp(14px,4vw,28px) clamp(44px,5.5vw,80px)'}}>
          <div id="brands" style={{maxWidth: '1200px', margin: '0 auto', background: '#fff', border: '1px solid var(--hairline)', borderRadius: '36px', boxShadow: '0 40px 90px -50px rgba(40,45,25,.3)', padding: 'clamp(44px,5.5vw,72px) clamp(24px,4vw,48px)'}}>
          <div style={{maxWidth: '1200px', margin: '0 auto', textAlign: 'center'}}>
            <h2 style={{fontFamily: 'var(--font-display)', fontWeight: '800', letterSpacing: '-0.035em', lineHeight: '1.04', fontSize: 'clamp(28px,3.8vw,48px)', margin: '0', color: 'var(--ink)'}}>How it <span style={{fontFamily: 'var(--font-serif)', fontStyle: 'italic', fontWeight: '400'}}>works</span></h2>
          </div>

          <div style={{maxWidth: '1200px', margin: 'clamp(20px,2.5vw,32px) auto 0', display: 'flex', flexDirection: 'column', gap: 'clamp(16px,2vw,28px)'}}>

            {/* 01 Offers */}
            <div className="sr" style={{display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(min(100%,330px),1fr))', gap: 'clamp(28px,4vw,60px)', alignItems: 'center', background: 'linear-gradient(135deg,#EFFAF5 0%,#fff 60%)', borderRadius: '28px', padding: 'clamp(28px,4vw,56px)'}}>
              <div>
                <div style={{display: 'inline-flex', alignItems: 'center', gap: '9px', background: 'var(--card)', border: '1px solid var(--frost-edge)', borderRadius: 'var(--radius-pill)', padding: '5px 14px 5px 5px', boxShadow: '0 6px 16px -10px rgba(40,45,25,.4)'}}><span style={{display: 'inline-flex', alignItems: 'center', justifyContent: 'center', width: '24px', height: '24px', borderRadius: '50%', background: 'var(--neon)', fontFamily: 'var(--font-display)', fontWeight: '800', fontSize: '11px', color: 'var(--ink)'}}>01</span><span className="t-meta" style={{color: 'var(--ink-soft)'}}>Offers</span></div>
                ...
                <div style={{display: 'flex', flexWrap: 'wrap', gap: '8px', marginTop: '22px'}}>
                  <span style={{display: 'inline-flex', alignItems: 'center', gap: '6px', fontFamily: 'var(--font-ui)', fontSize: '12.5px', fontWeight: '600', color: 'var(--ink)', background: 'var(--card)', border: '1px solid var(--frost-edge)', borderRadius: 'var(--radius-pill)', padding: '7px 13px'}}><svg width="13" height="13" sc-camel-view-box="0 0 24 24" fill="none" stroke="#181C24" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><path d="M20 6 9 17l-5-5"></path></svg>Agreed upfront</span>
              ...
              <div className="sr sr-rot" style={{'--sr-delay': '.15s', '--sr-rot': '-2deg', display: 'flex', justifyContent: 'center'}}>
                <div className="lift" style={{width: 'min(400px,100%)'}}>
                  <div className="fgcard">
                    ...
                    <div style={{display: 'flex', alignItems: 'center', gap: '12px', padding: '14px 0 16px'}}><div style={{width: '44px', height: '44px', borderRadius: '50%', background: '#FFFFFF', border: '1px solid var(--hairline)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: '0'}}><svg width="19" height="19" sc-camel-view-box="0 0 24 24" fill="none" stroke="var(--ink-faint)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="8" r="4"></circle><path d="M4 21c0-4 4-6 8-6s8 2 8 6"></path></svg></div><div><div style={{fontFamily: 'var(--font-ui)', fontWeight: '700', fontSize: '15px'}}>Rohan Mehta</div><div style={{fontFamily: 'var(--font-ui)', fontSize: '11.5px', color: 'var(--ink-faint)', marginTop: '2px'}}>Finance · 180K · 94% match</div></div></div>
            ...
            {/* 03 Payments */}
            <div className="sr" style={{display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(min(100%,330px),1fr))', gap: 'clamp(28px,4vw,60px)', alignItems: 'center', background: 'linear-gradient(135deg,#F5F0FD 0%,#fff 60%)', borderRadius: '28px', padding: 'clamp(28px,4vw,56px)'}}>
              <div>
                <div style={{display: 'inline-flex', alignItems: 'center', gap: '9px', background: 'var(--card)', border: '1px solid var(--frost-edge)', borderRadius: 'var(--radius-pill)', padding: '5px 14px 5px 5px', boxShadow: '0 6px 16px -10px rgba(40,45,25,.4)'}}><span style={{display: 'inline-flex', alignItems: 'center', justifyContent: 'center', width: '24px', height: '24px', borderRadius: '50%', background: 'var(--neon)', fontFamily: 'var(--font-display)', fontWeight: '800', fontSize: '11px', color: 'var(--ink)'}}>03</span><span className="t-meta" style={{color: 'var(--ink-soft)'}}>Analytics</span></div>
                <h3 className="t-title" style={{margin: '14px 0 0'}}>See what's working, <span className="t-accent">at a glance</span></h3>
                  ...
                  <div className="fgcard">
                    ...
                    <div style={{display: 'flex', flexDirection: 'column', gap: '16px'}}>
                      <div style={{display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: '10px'}}>
                        <div style={{background: 'var(--card)', border: '1px solid var(--border-hairline)', borderRadius: '14px', padding: '12px'}}><div style={{fontFamily: 'var(--font-ui)', fontSize: '10.5px', color: 'var(--ink-faint)'}}>Reach</div><div style={{fontFamily: 'var(--font-display)', fontWeight: '800', fontSize: '18px', marginTop: '4px'}}>2.4M</div></div>
                        <div style={{background: 'var(--card)', border: '1px solid var(--border-hairline)', borderRadius: '14px', padding: '12px'}}><div style={{fontFamily: 'var(--font-ui)', fontSize: '10.5px', color: 'var(--ink-faint)'}}>Engagement</div><div style={{fontFamily: 'var(--font-display)', fontWeight: '800', fontSize: '18px', marginTop: '4px'}}>6.8%</div></div>
                        <div style={{background: 'var(--card)', border: '1px solid var(--border-hairline)', borderRadius: '14px', padding: '12px'}}><div style={{fontFamily: 'var(--font-ui)', fontSize: '10.5px', color: 'var(--ink-faint)'}}>CPV</div><div style={{fontFamily: 'var(--font-display)', fontWeight: '800', fontSize: '18px', marginTop: '4px'}}>₹0.32</div></div>
                      </div>
                      <div>
                        ...
                        <div style={{display: 'flex', flexDirection: 'column', gap: '9px'}}>
                          <div style={{display: 'flex', alignItems: 'center', gap: '10px'}}><span style={{fontFamily: 'var(--font-ui)', fontSize: '12.5px', fontWeight: '600', width: '56px', flexShrink: '0'}}>@meera.k</span><span style={{flex: '1', height: '8px', borderRadius: '4px', background: 'var(--border-hairline)', overflow: 'hidden'}}><span style={{display: 'block', height: '100%', width: '88%', borderRadius: '4px', background: '#12151C'}}></span></span></div>
                          <div style={{display: 'flex', alignItems: 'center', gap: '10px'}}><span style={{fontFamily: 'var(--font-ui)', fontSize: '12.5px', fontWeight: '600', width: '56px', flexShrink: '0'}}>@arjun.fit</span><span style={{flex: '1', height: '8px', borderRadius: '4px', background: 'var(--border-hairline)', overflow: 'hidden'}}><span style={{display: 'block', height: '100%', width: '64%', borderRadius: '4px', background: '#12151C'}}></span></span></div>
                          <div style={{display: 'flex', alignItems: 'center', gap: '10px'}}><span style={{fontFamily: 'var(--font-ui)', fontSize: '12.5px', fontWeight: '600', width: '56px', flexShrink: '0'}}>@nina.style</span><span style={{flex: '1', height: '8px', borderRadius: '4px', background: 'var(--border-hairline)', overflow: 'hidden'}}><span style={{display: 'block', height: '100%', width: '41%', borderRadius: '4px', background: '#12151C'}}></span></span></div>
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        <section style={{position: 'relative', width: '100vw', left: '50%', right: '50%', marginLeft: '-50vw', marginRight: '-50vw', height: 'auto', overflow: 'hidden', background: '#FFFFFF'}}>
          <div className="ws-grid">
            <div className="ws-imgwrap"><div id="brandsWsImg" aria-hidden="true" data-placeholder="Brand team photo" style={{width: '100%', height: '100%'}} /></div>
            <div className="ws-right">
              <div className="ws-content">
                ...
                <h2 className="ws-headline" style={{fontFamily: 'var(--font-display)', fontWeight: '800', letterSpacing: '-0.03em', lineHeight: '1.02', fontSize: 'clamp(26px,3vw,38px)'}}>
                ...
                <div className="ws-table">
                  ...
                  <div className="ws-cell ws-cell-body ws-mark"><span className="ws-yes"><svg width="18" height="18" sc-camel-view-box="0 0 24 24" fill="none" stroke="#12151C" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round"><path d="M20 6 9 17l-5-5"></path></svg></span></div>
                  <div className="ws-cell ws-cell-body ws-mark"><svg width="18" height="18" sc-camel-view-box="0 0 24 24" fill="none" stroke="#878D99" strokeWidth="1.75" strokeLinecap="round"><path d="M18 6 6 18M6 6l12 12"></path></svg></div>
        ...
        {/* ============ FEATURE GRID ============ */}
        <section style={{padding: 'clamp(44px,5.5vw,80px) clamp(14px,4vw,28px) clamp(44px,5.5vw,80px)'}}>
          <div style={{position: 'relative', maxWidth: '1200px', margin: '0 auto', borderRadius: 'clamp(24px,2.6vw,38px)', overflow: 'hidden', background: '#FFFFFF', border: '1px solid var(--hairline)', boxShadow: '0 30px 66px -40px rgba(40,45,25,.22),0 6px 18px -10px rgba(40,45,25,.12)'}}>
            <div style={{position: 'relative', zIndex: '2', padding: 'clamp(40px,5vw,76px) clamp(22px,4.4vw,64px)'}}>
              ...
              <div style={{marginTop: 'clamp(32px,4vw,52px)', display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(min(100%,280px),1fr))', gap: '18px'}}>
                <div className="lift sr" style={{'--sr-delay': '0s'}}><div className="fgcard"><span style={{display: 'inline-flex', alignItems: 'center', justifyContent: 'center', width: '56px', height: '56px', borderRadius: '17px', background: '#F2FAF6', border: '1px solid var(--hairline)', marginBottom: '14px'}}><svg width="24" height="24" sc-camel-view-box="0 0 24 24" fill="none" stroke="#565C68" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><path d="M14 3v4a1 1 0 0 0 1 1h4"></path><path d="M5 21V5a2 2 0 0 1 2-2h7l5 5v13a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2Z"></path><path d="M9 13h6"></path><path d="M9 17h4"></path></svg></span><h3 className="t-subhead" style={{margin: '0'}}>Structured briefs</h3><p style={{fontFamily: 'var(--font-ui)', fontSize: '13.5px', lineHeight: '1.55', color: 'var(--ink-soft)', margin: '8px 0 0'}}>Same format, every time.</p></div></div>
                <div className="lift sr" style={{'--sr-delay': '.06s'}}><div className="fgcard"><span style={{display: 'inline-flex', alignItems: 'center', justifyContent: 'center', width: '56px', height: '56px', borderRadius: '17px', background: '#F0F6FD', border: '1px solid var(--hairline)', marginBottom: '14px'}}><svg width="24" height="24" sc-camel-view-box="0 0 24 24" fill="none" stroke="#565C68" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><path d="M14 3v4a1 1 0 0 0 1 1h4"></path><path d="M5 21V5a2 2 0 0 1 2-2h7l5 5v13a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2Z"></path><path d="m9 15 2 2 4-4"></path></svg></span><h3 className="t-subhead" style={{margin: '0'}}>Agreed terms on record</h3><p style={{fontFamily: 'var(--font-ui)', fontSize: '13.5px', lineHeight: '1.55', color: 'var(--ink-soft)', margin: '8px 0 0'}}>Locked the moment you agree.</p></div></div>
                <div className="lift sr" style={{'--sr-delay': '.12s'}}><div className="fgcard"><span style={{display: 'inline-flex', alignItems: 'center', justifyContent: 'center', width: '56px', height: '56px', borderRadius: '17px', background: '#F6F1FC', border: '1px solid var(--hairline)', marginBottom: '14px'}}><svg width="24" height="24" sc-camel-view-box="0 0 24 24" fill="none" stroke="#565C68" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z"></path><circle cx="12" cy="12" r="3"></circle></svg></span><h3 className="t-subhead" style={{margin: '0'}}>Deliverable review</h3><p style={{fontFamily: 'var(--font-ui)', fontSize: '13.5px', lineHeight: '1.55', color: 'var(--ink-soft)', margin: '8px 0 0'}}>Approve and revise in one place.</p></div></div>
                <div className="lift sr" style={{'--sr-delay': '.18s'}}><div className="fgcard"><span style={{display: 'inline-flex', alignItems: 'center', justifyContent: 'center', width: '56px', height: '56px', borderRadius: '17px', background: '#FDF9EE', border: '1px solid var(--hairline)', marginBottom: '14px'}}><svg width="24" height="24" sc-camel-view-box="0 0 24 24" fill="none" stroke="#565C68" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="5" width="20" height="14" rx="2"></rect><line x1="2" y1="10" x2="22" y2="10"></line></svg></span><h3 className="t-subhead" style={{margin: '0'}}>Payment tracking</h3><p style={{fontFamily: 'var(--font-ui)', fontSize: '13.5px', lineHeight: '1.55', color: 'var(--ink-soft)', margin: '8px 0 0'}}>Agreed to closed, live.</p></div></div>
                <div className="lift sr" style={{'--sr-delay': '.24s'}}><div className="fgcard"><span style={{display: 'inline-flex', alignItems: 'center', justifyContent: 'center', width: '56px', height: '56px', borderRadius: '17px', background: '#FCF2F2', border: '1px solid var(--hairline)', marginBottom: '14px'}}><svg width="24" height="24" sc-camel-view-box="0 0 24 24" fill="none" stroke="#565C68" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><path d="m17 2 4 4-4 4"></path><path d="M3 11v-1a4 4 0 0 1 4-4h14"></path><path d="m7 22-4-4 4-4"></path><path d="M21 13v1a4 4 0 0 1-4 4H3"></path></svg></span><h3 className="t-subhead" style={{margin: '0'}}>One-tap re-engagement</h3><p style={{fontFamily: 'var(--font-ui)', fontSize: '13.5px', lineHeight: '1.55', color: 'var(--ink-soft)', margin: '8px 0 0'}}>Re-run a deal in one tap.</p></div></div>
                <div className="lift sr" style={{'--sr-delay': '.3s'}}><div className="fgcard"><span style={{display: 'inline-flex', alignItems: 'center', justifyContent: 'center', width: '56px', height: '56px', borderRadius: '17px', background: '#E9F7F0', border: '1px solid var(--hairline)', marginBottom: '14px'}}><svg width="24" height="24" sc-camel-view-box="0 0 24 24" fill="none" stroke="#565C68" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><path d="M22 12h-4l-3 9L9 3l-3 9H2"></path></svg></span><h3 className="t-subhead" style={{margin: '0'}}>Full deal timeline</h3><p style={{fontFamily: 'var(--font-ui)', fontSize: '13.5px', lineHeight: '1.55', color: 'var(--ink-soft)', margin: '8px 0 0'}}>One chronological record.</p></div></div>
              </div>
            </div>
          </div>
        </section>
        {/* ============ BRAND SIDE SHOWCASE ============ */}
        <section style={{position: 'relative', padding: 'clamp(44px,5.5vw,80px) clamp(14px,4vw,28px) clamp(44px,5.5vw,80px)'}}>
          <div style={{maxWidth: '1200px', margin: '0 auto', position: 'relative', borderRadius: '40px', overflow: 'hidden', boxShadow: '0 40px 90px -40px rgba(40,45,25,.35)'}}>
            <img src="/brands/showcase-b.webp" alt="Brand dashboard cards — active campaigns, applicants, contracts, payouts" style={{...{width: '100%', aspectRatio: '1672/941', display: 'block'}, objectFit: 'cover'}} />
            <div style={{position: 'absolute', left: '0', right: '0', top: '0', padding: 'clamp(22px,3vw,36px) clamp(28px,4vw,48px) clamp(14px,2.2vw,28px)', textAlign: 'center'}}>
              <h2 style={{fontFamily: 'var(--font-display)', fontWeight: '800', letterSpacing: '-0.035em', lineHeight: '1.04', fontSize: 'clamp(28px,3.4vw,42px)', margin: '0 auto', maxWidth: '480px', color: '#12151C'}}>Every campaign,<br /><span style={{fontFamily: 'var(--font-serif)', fontStyle: 'italic', fontWeight: '400'}}>in one place.</span></h2>
            </div>
          </div>
        </section>

        {/* ============ YOUR DATA (privacy statement) ============ */}
        <section id="privacySec" style={{padding: 'clamp(28px,3.5vw,48px) clamp(14px,4vw,28px)'}}>
          <div style={{maxWidth: '1200px', margin: '0 auto', background: '#fff', border: '1px solid var(--hairline)', borderRadius: 'clamp(24px,2.6vw,38px)', boxShadow: '0 36px 80px -56px rgba(40,45,25,.28)', padding: 'clamp(40px,5vw,76px) clamp(22px,4.4vw,64px)'}}>
            <div style={{textAlign: 'left', maxWidth: '460px'}}>
              <div id="pvEyebrow" className="t-meta" style={{color: 'var(--ink-3)', opacity: '0', transform: 'translateY(16px)', transition: 'opacity .22s ease,transform .22s cubic-bezier(.16,1,.3,1)'}}>YOUR DATA</div>
              <h2 id="pvHead" className="t-title" style={{margin: '16px 0 0', color: 'var(--ink)', fontSize: 'clamp(28px,3.4vw,38px)', opacity: '0', transform: 'translateY(24px)', transition: 'opacity .32s cubic-bezier(.16,1,.3,1),transform .32s cubic-bezier(.16,1,.3,1)'}}>As private as your <span style={{fontFamily: 'var(--font-serif)', fontStyle: 'italic', fontWeight: '400'}}>spreadsheet.</span></h2>
              <p id="pvBody" className="t-body" style={{color: 'var(--ink-2)', margin: '16px 0 0', opacity: '0', transform: 'translateY(16px)', transition: 'opacity .28s ease,transform .28s cubic-bezier(.16,1,.3,1)'}}>Your creator list, your rates, your spend and your strategy stay yours. No other brand on guapd can see any of it.</p>
            </div>
            <div style={{background: '#fff', border: '1px solid var(--hairline)', boxShadow: '0 20px 44px -30px rgba(40,45,25,.35)', borderRadius: '20px', padding: '8px 32px', marginTop: '40px'}}>
              <div className="pv-row pv-hover" style={{display: 'flex', gap: '18px', alignItems: 'center', padding: '22px 0', borderBottom: '1px solid var(--hairline)', opacity: '0', transform: 'translateY(16px)', transition: 'opacity .4s ease,transform .4s cubic-bezier(.16,1,.3,1)'}}>
                ...
                <svg width="20" height="20" sc-camel-view-box="0 0 24 24" fill="none" stroke="var(--ink-3)" strokeWidth="1.6" style={{padding: '12px', borderRadius: '12px', background: '#E9F7F0', boxSizing: 'content-box'}}><path d="M1.5 12S5 5.5 12 5.5 22.5 12 22.5 12 19 18.5 12 18.5 1.5 12 1.5 12Z"></path><circle cx="12" cy="12" r="3"></circle></svg>
              </div>
              <div className="pv-row pv-hover" style={{display: 'flex', gap: '18px', alignItems: 'center', padding: '22px 0', borderBottom: '1px solid var(--hairline)', opacity: '0', transform: 'translateY(16px)', transition: 'opacity .4s ease,transform .4s cubic-bezier(.16,1,.3,1)'}}>
                ...
                <svg width="20" height="20" sc-camel-view-box="0 0 24 24" fill="none" stroke="var(--ink-3)" strokeWidth="1.6" style={{padding: '12px', borderRadius: '12px', background: '#F0EAFD', boxSizing: 'content-box'}}><circle cx="12" cy="12" r="9.5"></circle><line x1="5.4" y1="18.6" x2="18.6" y2="5.4"></line></svg>
              </div>
              <div className="pv-row pv-hover" style={{display: 'flex', gap: '18px', alignItems: 'center', padding: '22px 0', opacity: '0', transform: 'translateY(16px)', transition: 'opacity .4s ease,transform .4s cubic-bezier(.16,1,.3,1)'}}>
                ...
                <svg width="20" height="20" sc-camel-view-box="0 0 24 24" fill="none" stroke="var(--ink-3)" strokeWidth="1.6" style={{padding: '12px', borderRadius: '12px', background: '#FCF6E4', boxSizing: 'content-box'}}><rect x="5" y="10.5" width="14" height="10" rx="2.4"></rect><path d="M8 10.5V7.2A4 4 0 0 1 16 7.2"></path></svg>
              </div>
            </div>
          </div>
        </section>
        ...
        {/* ============ CREATORS & BRANDS ============ */}
        <section style={{padding: 'clamp(44px,5.5vw,80px) clamp(20px,5vw,72px)'}}>
          <div style={{maxWidth: '1200px', margin: '0 auto'}}>
            <div style={{textAlign: 'center', maxWidth: '620px', margin: '0 auto clamp(36px,4.5vw,56px)'}}>
              ...
              <h2 style={{fontFamily: 'var(--font-display)', fontWeight: '800', letterSpacing: '-0.035em', lineHeight: '1.04', fontSize: 'clamp(28px,3.8vw,48px)', margin: '12px 0 0', color: 'var(--ink)'}}>Find creators for every campaign</h2>
            </div>
            <div style={{display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(min(100%,210px),1fr))', gap: 'clamp(22px,3vw,34px)', maxWidth: '1200px', margin: '0 auto'}}>
              <div className="card sr" style={{'--sr-delay': '0s', background: 'var(--card)', border: '1.2px solid var(--hairline)', borderRadius: '24px', padding: '14px', boxShadow: '0 22px 50px -28px rgba(40,45,25,.34)'}}><div style={{width: '100%', height: 'auto', aspectRatio: '1/1', display: 'block', borderRadius: '16px', border: '1px solid var(--hairline)', background: '#FFFFFF'}}></div><div style={{padding: '16px 6px 6px'}}><div style={{fontFamily: 'var(--font-display)', fontWeight: '700', fontSize: '16px', letterSpacing: '-0.01em', color: 'var(--ink)'}}>@aisha.fin</div><div style={{display: 'flex', alignItems: 'center', gap: '8px', marginTop: '10px'}}><span style={{fontFamily: 'var(--font-ui)', fontSize: '12px', fontWeight: '600', color: 'var(--ink)', background: '#FFFFFF', border: '1px solid var(--hairline)', borderRadius: 'var(--radius-pill)', padding: '3px 10px'}}>Finance</span><span style={{fontFamily: 'var(--font-ui)', fontSize: '12.5px', color: 'var(--ink-faint)'}}>180K followers</span></div></div></div>
              <div className="card sr" style={{'--sr-delay': '.08s', background: 'var(--card)', border: '1.2px solid var(--hairline)', borderRadius: '24px', padding: '14px', boxShadow: '0 22px 50px -28px rgba(40,45,25,.34)'}}><div style={{width: '100%', height: 'auto', aspectRatio: '1/1', display: 'block', borderRadius: '16px', border: '1px solid var(--hairline)', background: '#FFFFFF'}}></div><div style={{padding: '16px 6px 6px'}}><div style={{fontFamily: 'var(--font-display)', fontWeight: '700', fontSize: '16px', letterSpacing: '-0.01em', color: 'var(--ink)'}}>@rohan.tech</div><div style={{display: 'flex', alignItems: 'center', gap: '8px', marginTop: '10px'}}><span style={{fontFamily: 'var(--font-ui)', fontSize: '12px', fontWeight: '600', color: 'var(--ink)', background: '#FFFFFF', border: '1px solid var(--hairline)', borderRadius: 'var(--radius-pill)', padding: '3px 10px'}}>Tech</span><span style={{fontFamily: 'var(--font-ui)', fontSize: '12.5px', color: 'var(--ink-faint)'}}>92K followers</span></div></div></div>
              <div className="card sr" style={{'--sr-delay': '.16s', background: 'var(--card)', border: '1.2px solid var(--hairline)', borderRadius: '24px', padding: '14px', boxShadow: '0 22px 50px -28px rgba(40,45,25,.34)'}}><div style={{width: '100%', height: 'auto', aspectRatio: '1/1', display: 'block', borderRadius: '16px', border: '1px solid var(--hairline)', background: '#FFFFFF'}}></div><div style={{padding: '16px 6px 6px'}}><div style={{fontFamily: 'var(--font-display)', fontWeight: '700', fontSize: '16px', letterSpacing: '-0.01em', color: 'var(--ink)'}}>@priya.career</div><div style={{display: 'flex', alignItems: 'center', gap: '8px', marginTop: '10px'}}><span style={{fontFamily: 'var(--font-ui)', fontSize: '12px', fontWeight: '600', color: 'var(--ink)', background: '#FFFFFF', border: '1px solid var(--hairline)', borderRadius: 'var(--radius-pill)', padding: '3px 10px'}}>Careers</span><span style={{fontFamily: 'var(--font-ui)', fontSize: '12.5px', color: 'var(--ink-faint)'}}>95K followers</span></div></div></div>
              <div className="card sr" style={{'--sr-delay': '.24s', background: 'var(--card)', border: '1.2px solid var(--hairline)', borderRadius: '24px', padding: '14px', boxShadow: '0 22px 50px -28px rgba(40,45,25,.34)'}}><div style={{width: '100%', height: 'auto', aspectRatio: '1/1', display: 'block', borderRadius: '16px', border: '1px solid var(--hairline)', background: '#FFFFFF'}}></div><div style={{padding: '16px 6px 6px'}}><div style={{fontFamily: 'var(--font-display)', fontWeight: '700', fontSize: '16px', letterSpacing: '-0.01em', color: 'var(--ink)'}}>@maya.money</div><div style={{display: 'flex', alignItems: 'center', gap: '8px', marginTop: '10px'}}><span style={{fontFamily: 'var(--font-ui)', fontSize: '12px', fontWeight: '600', color: 'var(--ink)', background: '#FFFFFF', border: '1px solid var(--hairline)', borderRadius: 'var(--radius-pill)', padding: '3px 10px'}}>Lifestyle</span><span style={{fontFamily: 'var(--font-ui)', fontSize: '12.5px', color: 'var(--ink-faint)'}}>210K followers</span></div></div></div>
            </div>
          </div>
        </section>
        ...
        {SHOW_BRAND_LOGOS && (<>
      {/* ============ BRANDS WE WORK WITH ============ */}
        <section style={{padding: 'clamp(44px,5.5vw,80px) clamp(20px,5vw,72px) clamp(44px,5.5vw,80px)'}}>
          <div style={{maxWidth: '1200px', margin: '0 auto', border: '1.2px solid var(--hairline)', borderRadius: '24px', background: 'var(--card)', boxShadow: '0 22px 50px -34px rgba(40,45,25,.3)', padding: 'clamp(32px,4.5vw,56px) clamp(20px,4vw,48px)', textAlign: 'center'}}>
            <span className="t-meta" style={{display: 'inline-block', color: 'var(--ink-faint)'}}>Brands we work with</span>
            <h2 style={{fontFamily: 'var(--font-display)', fontWeight: '800', letterSpacing: '-0.035em', lineHeight: '1.04', fontSize: 'clamp(28px,3.8vw,48px)', margin: '10px 0 clamp(24px,3.2vw,34px)', color: 'var(--ink)'}}>Brands you already know</h2>
            <div style={{display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'center', gap: '26px'}}>
              <div style={{display: 'flex', alignItems: 'center', gap: '11px', background: 'var(--card)', border: '1px solid var(--frost-edge)', borderRadius: '16px', padding: '12px 18px 12px 12px', boxShadow: '0 12px 30px -22px rgba(40,45,25,.3)'}}><div style={{width: '38px', height: '38px', flexShrink: '0', borderRadius: '50%', border: '1px solid var(--hairline)', background: '#EEF2F6', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'var(--font-ui)', fontWeight: '700', fontSize: '13px', color: 'var(--ink)'}}>NP</div><span style={{fontFamily: 'var(--font-display)', fontWeight: '700', fontSize: '16px', color: 'var(--ink)'}}>Novapay</span></div>
              <div style={{display: 'flex', alignItems: 'center', gap: '11px', background: 'var(--card)', border: '1px solid var(--frost-edge)', borderRadius: '16px', padding: '12px 18px 12px 12px', boxShadow: '0 12px 30px -22px rgba(40,45,25,.3)'}}><div style={{width: '38px', height: '38px', flexShrink: '0', borderRadius: '50%', border: '1px solid var(--hairline)', background: '#F1EFF5', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'var(--font-ui)', fontWeight: '700', fontSize: '13px', color: 'var(--ink)'}}>BM</div><span style={{fontFamily: 'var(--font-display)', fontWeight: '700', fontSize: '16px', color: 'var(--ink)'}}>Bluemint</span></div>
              <div style={{display: 'flex', alignItems: 'center', gap: '11px', background: 'var(--card)', border: '1px solid var(--frost-edge)', borderRadius: '16px', padding: '12px 18px 12px 12px', boxShadow: '0 12px 30px -22px rgba(40,45,25,.3)'}}><div style={{width: '38px', height: '38px', flexShrink: '0', borderRadius: '50%', border: '1px solid var(--hairline)', background: '#EFF4F0', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'var(--font-ui)', fontWeight: '700', fontSize: '13px', color: 'var(--ink)'}}>CF</div><span style={{fontFamily: 'var(--font-display)', fontWeight: '700', fontSize: '16px', color: 'var(--ink)'}}>Cliqfin</span></div>
              <div style={{display: 'flex', alignItems: 'center', gap: '11px', background: 'var(--card)', border: '1px solid var(--frost-edge)', borderRadius: '16px', padding: '12px 18px 12px 12px', boxShadow: '0 12px 30px -22px rgba(40,45,25,.3)'}}><div style={{width: '38px', height: '38px', flexShrink: '0', borderRadius: '50%', border: '1px solid var(--hairline)', background: '#F7F5EC', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'var(--font-ui)', fontWeight: '700', fontSize: '13px', color: 'var(--ink)'}}>LW</div><span style={{fontFamily: 'var(--font-display)', fontWeight: '700', fontSize: '16px', color: 'var(--ink)'}}>Loopwear</span></div>
            </div>
          </div>
        </section>
      ...
      {SHOW_TESTIMONIALS && (<>
      {/* ============ TESTIMONIALS ============ */}
        <section id="creators" style={{padding: '0', marginTop: 'clamp(32px,4vw,56px)'}}>
          <div style={{position: 'relative', minHeight: '640px'}}>
            <img src="/brands/showcase-c.webp" alt="Brand team lifestyle photo — moody, editorial" style={{...{width: '100%', height: '80vh', minHeight: '640px', display: 'block', objectPosition: 'top', opacity: '0.5'}, objectFit: 'cover'}} />
            <div style={{position: 'absolute', left: '0', right: '0', top: '17%', textAlign: 'center', padding: '0 20px'}}>
              <h2 style={{fontFamily: 'var(--font-display)', fontWeight: '800', letterSpacing: '-0.035em', lineHeight: '1.04', fontSize: 'clamp(34px,3vw,46px)', margin: '0 auto', maxWidth: '45%', color: '#12151C'}}>Run deals directly. Stay <span style={{fontFamily: 'var(--font-serif)', fontStyle: 'italic', fontWeight: '400'}}>calm.</span></h2>
            ...
            <div className="brandsTrack" style={{display: 'flex', gap: '52px', overflowX: 'auto', scrollSnapType: 'x mandatory', padding: '0 clamp(24px,5vw,72px)'}}>
              <div className="card sr" style={{'--sr-delay': '0s', scrollSnapAlign: 'start', flex: '0 0 30%', minWidth: '280px', background: 'rgba(43,51,36,.72)', backdropFilter: 'blur(6px)', borderRadius: '20px', padding: '24px 28px', display: 'flex', flexDirection: 'column'}}>
                ...
                <h3 style={{fontFamily: 'var(--font-display)', fontWeight: '800', fontSize: '20px', letterSpacing: '-0.02em', margin: '8px 0 0', color: '#fff'}}>Three deals closed in a week</h3>
                <p style={{fontFamily: 'var(--font-ui)', fontSize: '13px', lineHeight: '1.5', color: 'rgba(255,255,255,.72)', margin: '8px 0 0'}}>Every term was agreed before a single frame was shot. No more back-and-forth over DMs.</p>
                <div style={{marginTop: '16px', borderTop: '1px solid rgba(255,255,255,.16)', paddingTop: '14px', display: 'flex', alignItems: 'center', justifyContent: 'space-between'}}>
                  <span style={{fontFamily: 'var(--font-ui)', fontWeight: '700', fontSize: '14px', color: '#fff'}}>Brand manager</span>
                  <span style={{fontFamily: 'var(--font-ui)', fontSize: '12px', color: 'rgba(255,255,255,.6)'}}>fintech startup</span>
                </div>
              </div>
              <div className="card sr" style={{'--sr-delay': '.06s', scrollSnapAlign: 'start', flex: '0 0 30%', minWidth: '280px', background: 'rgba(255,255,255,.78)', backdropFilter: 'blur(6px)', borderRadius: '20px', padding: '24px 28px', display: 'flex', flexDirection: 'column'}}>
                <span style={{color: 'var(--neon-deep)', fontSize: '12px', letterSpacing: '2px'}}>★★★★★</span>
                <h3 style={{fontFamily: 'var(--font-display)', fontWeight: '800', fontSize: '20px', letterSpacing: '-0.02em', margin: '8px 0 0', color: 'var(--ink)'}}>The paper trail is worth it</h3>
                <p style={{fontFamily: 'var(--font-ui)', fontSize: '13px', lineHeight: '1.5', color: 'var(--ink-soft)', margin: '8px 0 0'}}>No more WhatsApp screenshots to settle a dispute — everything's on record.</p>
                <div style={{marginTop: '16px', borderTop: '1px solid var(--border-hairline)', paddingTop: '14px', display: 'flex', alignItems: 'center', justifyContent: 'space-between'}}>
                  <span style={{fontFamily: 'var(--font-ui)', fontWeight: '700', fontSize: '14px', color: 'var(--ink)'}}>Growth lead</span>
                  <span style={{fontFamily: 'var(--font-ui)', fontSize: '12px', color: 'var(--ink-faint)'}}>D2C brand</span>
                </div>
              </div>
              <div className="card sr" style={{'--sr-delay': '.12s', scrollSnapAlign: 'start', flex: '0 0 30%', minWidth: '280px', background: 'rgba(43,51,36,.72)', backdropFilter: 'blur(6px)', borderRadius: '20px', padding: '24px 28px', display: 'flex', flexDirection: 'column'}}>
                <span style={{color: 'var(--neon-deep)', fontSize: '12px', letterSpacing: '2px'}}>★★★★★</span>
                <h3 style={{fontFamily: 'var(--font-display)', fontWeight: '800', fontSize: '20px', letterSpacing: '-0.02em', margin: '8px 0 0', color: '#fff'}}>Payments are finally calm</h3>
                <p style={{fontFamily: 'var(--font-ui)', fontSize: '13px', lineHeight: '1.5', color: 'rgba(255,255,255,.72)', margin: '8px 0 0'}}>I can see each payout without asking finance for an update.</p>
                <div style={{marginTop: '16px', borderTop: '1px solid rgba(255,255,255,.16)', paddingTop: '14px', display: 'flex', alignItems: 'center', justifyContent: 'space-between'}}>
                  <span style={{fontFamily: 'var(--font-ui)', fontWeight: '700', fontSize: '14px', color: '#fff'}}>Marketing head</span>
                  <span style={{fontFamily: 'var(--font-ui)', fontSize: '12px', color: 'rgba(255,255,255,.6)'}}>BFSI brand</span>
                </div>
              </div>
            </div>
            </div>
      ...
      {/* ============ INTERSTITIAL — WHATSAPP (full-bleed) ============ */}
    </div>
  )
}
