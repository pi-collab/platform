...
export default function PackageFeeNote({ isGrowth, pricePaise, showFirstDealNote = false }: {
  ...
  return (
    <div style={{ borderRadius: 18, background: '#F7F8F4', padding: '18px 20px', display: 'flex', flexDirection: 'column', gap: 14 }}>
      ...
      {/* The drawn note ends in this link, and now it has somewhere to go. */}
      <a
        href="/creator/pricing"
        style={{ display: 'inline-flex', alignItems: 'center', gap: 4, fontSize: 12.5, fontWeight: 600, color: 'var(--ink)', textDecoration: 'none' }}
      >
        See full pricing
