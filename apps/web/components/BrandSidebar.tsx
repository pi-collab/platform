            ...
            <div ref={avatarRef} style={{ position: 'relative' }}>
              ...
              {avatarOpen && (
                <div className="pmenu" style={dropdown}>
                  ...
                  {/* Pricing. Beside Payments because it answers the same
                      question from the other end: what this costs, and where
                      our fee comes from. */}
                  <Link href="/pricing" onClick={() => setAvatarOpen(false)} className="pmi" style={pmiStyle}>
                    <span style={pmiIconWrap}><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="19" x2="5" y1="5" y2="19" /><circle cx="6.5" cy="6.5" r="2.5" /><circle cx="17.5" cy="17.5" r="2.5" /></svg></span>
                    <span style={{ flex: 1, minWidth: 0 }}><span style={pmiLabel}>Pricing</span><span style={pmiSub}>What you pay, and our fee</span></span>
                  </Link>
                  {/* Payments */}
