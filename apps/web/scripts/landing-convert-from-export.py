...
# ── 1n. The converge headline stays exactly as exported. ─────────────────
# An earlier pass reworded it to "Get going. Get guapd."; that was not asked
# for. The export's own line is the copy, on both the animated section and the
# .cv-reduced fallback that prefers-reduced-motion shows instead.
step("converge headline left as exported",
     html.count('Where brands and creators'), html.count('Where brands and creators'))
